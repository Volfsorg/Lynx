...
contract LynxDividendDistributor is ILynxDividendDistributor {
    ...
    IERC20 reflectionToken = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    ...
    constructor (address _router) {
        router = _router != address(0) ? IJoeRouter02(_router) : IJoeRouter02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        _token = msg.sender;
    }
